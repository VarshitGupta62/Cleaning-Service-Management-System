 				...
 				<div class="card card-body">
 					...
 					<div class="row">
 						<div class="col-sm-12 col-xs-12">
 							<form method="post" action="<?= base_url(''); ?>admin_panel/Service_type/edit/<?php echo $all->id; ?>">
 								<div class="form-group">
 									<label for="exampleInputEmail111">Service type</label>
 									<input type="text" name="service_type" class="form-control" id="exampleInputEmail111" value="<?= $all->service_type ?>">
 								</div>
