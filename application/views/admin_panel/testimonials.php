				...
				<div class="d-flex align-items-center">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"> Testimonials Master</li>
						</ol>
					</nav>
				</div>
				<h4 class="page-title"> Testimonials Master</h4>
			</div>
				...
				<div class="card card-body">
					...
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<form method="post" action="<?= base_url(''); ?>admin_panel/Testimonials1/data_in" enctype="multipart/form-data">
								<div class="form-group">
									<label>User Name</label>
									<input type="text" name="username" class="form-control" id="exampleInputEmail111" placeholder="Enter Username">
								</div>
								<div class="form-group">
									<label>Tittle</label>
									<input type="title" name="title" class="form-control" id="exampleInputEmail12" placeholder="Enter your title">
								</div>
								...
								<tr>
									...
									<td>
										<div class="row button-group">
											<form method="POST" action="<?= base_url(''); ?>admin_panel/Testimonials1/delete_data/<?php echo $value->id; ?>">
											...
											<!-- <br> -->
											<form method="POST" action="<?= base_url(''); ?>admin_panel/Testimonials1/edit_data/<?php echo $value->id; ?>">
