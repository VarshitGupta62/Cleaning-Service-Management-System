 				...
 				<div class="card card-body">
 					...
 					<div class="row">
 						<div class="col-sm-12 col-xs-12">
 							<form method="post" action="<?= base_url(''); ?>admin_panel/Testimonials1/change_data/<?php echo $data->id; ?>">
 								<div class="form-group">
 									<label for="exampleInputEmail111">Username</label>
 									<input type="text" name="username" class="form-control" id="exampleInputEmail111" value="<?php echo $data->username; ?>">
 								</div>
 								<div class="form-group">
 									<label for="exampleInputEmail111">Tittle</label>
 									<input type="text" name="title" class="form-control" id="exampleInputEmail111" value="<?php echo $data->title; ?>">
 								</div>
 								<div class="form-group">

 									<label for="exampleInputEmail111">your image</label>
 									<br>
 									<img src="<?= base_url('uploads/' . $data->image); ?>" style="width: 200px; height: 200px;" alt="Uploaded Image">
 								</div>
